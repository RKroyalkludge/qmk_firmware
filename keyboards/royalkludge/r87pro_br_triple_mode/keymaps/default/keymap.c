...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT( /* Base */
        ...
        KC_LCTL,  KC_LCMD,  KC_LALT,                      KC_SPC,                       KC_RALT,  MO(_FL),  KC_APP,   KC_RCTL,                      KC_LEFT,   KC_DOWN,  KC_RGHT),
    ...
    [_FL] = LAYOUT( /* Base */
        ...
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   _______,  _______,  _______,  _______,  _______,  MO(_DEFA),KC_2G4,   _______,  _______,  HS_BATQ,   _______,  _______,  _______,
        _______,  KC_NO,    TO(_MBL), _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,  _______,            _______,   _______,
        _______,  _______,  DEB_TOG,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),           RGB_VAI,
        KC_LCTL,  GU_TOGG,  _______,                      EE_CLR,                       _______,  _______,  _______,  _______,                       RGB_SPD,  RGB_VAD,  RGB_SPI),
    ...
    [_MBL] = LAYOUT( /* Base */
        ...
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_BSLS,  KC_MUTE,
        KC_LSFT,  KC_NUBS,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  0x0087,   KC_RSFT,             KC_UP,
        KC_LCTL,  KC_LALT,  KC_LCMD,                      KC_SPC,                       KC_RCMD,  MO(_MFL), KC_APP,   KC_RCTL,                      KC_LEFT,   KC_DOWN,  KC_RGHT),
    ...
    [_MFL] = LAYOUT( /* Base */
        ...
        _______,  RP_P0,    RP_P1,    RP_P2,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______, RGB_TOG,   RL_MOD,   RGB_HUI,  KC_PAUSE,
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   _______,  _______,  _______,  _______,  _______,  MO(_DEFA),KC_2G4,   _______,  _______, HS_BATQ,   _______,  _______,  _______,
        _______,  TO(_BL),  KC_NO,    _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,  _______,           _______,   _______,
        _______,  _______,  DEB_TOG,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,  _______,  _______, MO(_DEFA),           RGB_VAI,
        _______,  KC_LALT,  KC_LGUI,                      EE_CLR,                       KC_RGUI,  _______,  _______,  _______,                      RGB_SPD,  RGB_VAD,  RGB_SPI),
    ...
    [_DEFA] = LAYOUT( /* Base */
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  HS_BR,   _______,             _______,
