...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT( /* Base */
        ...
        _______,  _______,    _______,    _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,    KC_HOME,  KC_SCRL,             KC_INS,
        _______,  KC_NO,      TO(_MBL),   _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,    KC_PSCR,  RGB_MOD,  _______,   KC_PAUSE,
        _______,  _______,    DEB_TOG,    _______,  _______,  _______,  NK_TOGG,  _______,  _______,  RGB_HUI,  _______,    0x0087,   MO(_DEFA),RGB_VAI,   KC_END,
        L_TOG,    GU_TOGG,    _______,                        EE_CLR,                                 _______,  _______,    RGB_SPD,            RGB_VAD,   RGB_SPI),
    ...
    [_MBL] = LAYOUT(  /* Base */
        ...
        KC_CAPS,  KC_A,       KC_S,       KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,    KC_QUOT,  KC_BSLS,  KC_ENT,    KC_PGUP,  
        KC_LSFT,  KC_NUBS,    KC_Z,       KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,     KC_SLSH,  KC_RSFT,  KC_UP,     KC_PGDN,
        KC_LCTL,  KC_LALT,    KC_LGUI,                        KC_SPC,                                 KC_RGUI,  MO(_MFL),   KC_LEFT,            KC_DOWN,   KC_RGHT),

    [_MFL] = LAYOUT(  /* FN */
        KC_GRV,   KC_F1,      KC_F2,      KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,     KC_F11,   KC_F12,   _______,   _______,
        _______,  _______,    _______,    _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,    KC_HOME,  KC_SCRL,             KC_INS,
        _______,  TO(_BL),    KC_NO,      _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,    KC_PSCR,  RGB_MOD,  _______,   KC_PAUSE,
        _______,  _______,    DEB_TOG,    _______,  _______,  _______,  NK_TOGG,  _______,  _______,  RGB_HUI,  _______,    0x0087,   MO(_DEFA),RGB_VAI,   KC_END,
        L_TOG,    _______,    _______,                        EE_CLR,                                 _______,  _______,    RGB_SPD,            RGB_VAD,   RGB_SPI),
    ...
    [_DEFA] = LAYOUT(  /* FN */
        ...
        _______,  _______,    _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    HS_BR,    _______,  _______,   _______,
