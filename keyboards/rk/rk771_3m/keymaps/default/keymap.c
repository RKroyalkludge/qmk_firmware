...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT( /* Base */
        _______,  KC_MYCM,   KC_WHOM,   KC_MAIL,  KC_CALC,    KC_MSEL,  KC_MSTP,  KC_MPRV,  KC_MPLY,  KC_MNXT,   KC_MUTE,  KC_VOLD,  KC_VOLU, _______,  RP_END,  RGB_MOD,  _______,
    ...
    [_MFL] = LAYOUT( /* Base */
        _______,  KC_BRID,   KC_BRIU,   _______,  _______,   RGB_VAD,   RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,   KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,  RP_END,   RGB_MOD,  KC_PAUSE,
        _______,  RP_P0,     RP_P1,     RP_P2,    _______,   _______,   _______,  _______,  _______,  _______,   _______,   _______, _______,  RGB_TOG,  RL_MOD,   RGB_HUI,  KC_PAUSE,  
        _______,  KC_BT1,    KC_BT2,    KC_BT3,   _______,   _______,   _______,  _______,  _______,  MO(_DEFA),  KC_2G4,   _______, _______,  _______,  _______,  _______,  _______, 
