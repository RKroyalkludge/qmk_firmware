...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT( /* Base */
        ...
        KC_LSFT,  KC_NUBS,    KC_Y,       KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,     KC_SLSH,  KC_RSFT,  KC_UP,     KC_PGDN,
        KC_LCTL,  KC_LGUI,    KC_LALT,                        KC_SPC,                                 KC_RALT,  MO(_FL),    KC_LEFT,            KC_DOWN,   KC_RGHT),

    [_FL] = LAYOUT( /* Base */
        KC_GRV,   KC_F1,      KC_F2,      KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,     KC_F11,   KC_F12,   _______,   _______,
        _______,  KC_BT1,     KC_BT2,     KC_BT3,   _______,  _______,  _______,  _______,  _______,  MO(_DEFA),KC_2G4,     KC_HOME,  KC_SCRL,             KC_INS,
        _______,  KC_NO,      TO(_MBL),   _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,    KC_PSCR,  RGB_MOD,  HS_BATQ,   KC_PAUSE,
        _______,  _______,    _______,    _______,  _______,  _______,  NK_TOGG,  _______,  _______,  RGB_HUI,  _______,    _______,  MO(_DEFA),RGB_VAI,   KC_END,
    ...
    [_MFL] = LAYOUT(  /* FN */
        KC_GRV,   KC_F1,      KC_F2,      KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,     KC_F11,   KC_F12,   _______,   _______,
        _______,  KC_BT1,     KC_BT2,     KC_BT3,   _______,  _______,  _______,  _______,  _______,  MO(_DEFA),KC_2G4,     KC_HOME,  KC_SCRL,             KC_INS,
        _______,  TO(_BL),    KC_NO,      _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,    KC_PSCR,  RGB_MOD,  HS_BATQ,   KC_PAUSE,
        _______,  _______,    _______,    _______,  _______,  _______,  NK_TOGG,  _______,  _______,  RGB_HUI,  _______,    _______,  MO(_DEFA),RGB_VAI,   KC_END,
