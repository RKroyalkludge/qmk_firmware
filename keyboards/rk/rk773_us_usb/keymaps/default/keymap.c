...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT( 
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,  _______,  _______,  _______,   _______,  _______,  _______,
        _______,  KC_NO,    TO(_MBL), _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,  _______,            _______,   _______,
        _______,  DEB_TOG,  _______,  _______,  _______,  NK_TOGG,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),                               RGB_VAI,
